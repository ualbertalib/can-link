...
export const FACET_QUERY = "&json.facet={universities: {type:terms,field:institution_str,limit:100}, uniShortNames: {type:terms, field:institution_short_str, limit:100}, subjects: {type:terms,field:subject,limit:100}, degrees: {type:terms,field:degree_name_str,limit:100}, languages: {type:terms,field:lang_str,limit:100}, years: {type:terms,field:year,limit:200}}";
